...
from .views import CrearReserva,ListarReserva,EliminarReserva,UpdateReservaView, listarReserva
from django.contrib.auth.decorators import login_required


urlpatterns = [
    path('gestion-reserva/crear-reserva',login_required(CrearReserva.as_view()),name='crear-reserva'),
    path('gestion-reserva/',login_required(listarReserva),name='listar-reserva'),
